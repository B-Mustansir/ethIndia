...
function BuiltWith() {
  const items = [
    ...
    { name: "Coinbase Developer Platform", icon: Coinbase, color: "#0056FF" },
    {
      name: "Polygon",
      icon: "https://cryptologos.cc/logos/polygon-matic-logo.svg",
      color: "#8247E5",
    },
    { name: "Citrea", icon: Citrea, color: "#FFD700" },
    { name: "Walrus", icon: Walrus, color: "#4CAF50" },
    { name: "Okto", icon: Okto, color: "#F7931A" },
  ];
  ...
  return (
    <div className="w-full bg-black text-white py-20">
      ...
      >
        <h2 className="text-7xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-purple-400 to-blue-500">
          Built With
        </h2>
